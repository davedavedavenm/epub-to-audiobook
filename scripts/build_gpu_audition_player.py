...
def build_player():
    candidates = [
        ...
        },
        {
            ...
            "file": OUT_DIR / "armed_struggle_breeze_liam_llm_norm.mp3",
            "desc": "<strong>Irish History Excerpt:</strong> Tested on First Dáil & 1916 Rising from <em>Armed Struggle</em>.<br/><strong>LLM Preprocessing:</strong> Authentic Irish Gaelic phonetics (<code>Doyle Air-un</code>, <code>CA-hal BROO-ha</code>, <code>Shin Fane</code>) + hyphenated years (<code>nineteen-seventeen</code>) + question uptalk.<br/><strong>Mastering:</strong> Warmth EQ + De-Esser + EBU R128.",
            "theme": "emerald",
            "icon": "🇮🇪"
        },
        {
            "id": "armed_struggle_breeze_liam_raw",
            "badge": "NEW 🇮🇪: Breeze 2 Liam (Armed Struggle - RAW Irish Spelling A/B)",
            "sub": "Modal L4 GPU • Cloned Liam (VCTK p374) • Pure Raw Text • 192k MP3",
            "file": OUT_DIR / "armed_struggle_breeze_liam_raw.mp3",
            "desc": "<strong>Direct A/B Comparison:</strong> Same Liam voice with un-normalized raw Irish orthography (<code>Dáil Éireann</code>, <code>Cathal Brugha</code>, <code>Sinn Féin</code>) and raw year digits to hear engine baseline pronunciation.",
            "theme": "cyan",
            "icon": "⚖️"
        },
        {
            "id": "armed_struggle_qwen3_aiden_emotive",
            "badge": "NEW 🎙️: Qwen3-TTS 1.7B Aiden (Dynamic LLM Emotional Direction)",
            "sub": "Modal L4 GPU • Studio Speaker Aiden • Scene-by-Scene Emotion Steering • 192k MP3",
            "file": OUT_DIR / "armed_struggle_qwen3_aiden_emotive_mastered.mp3",
            "desc": "<strong>Emotive Direction:</strong> Scene-by-scene instructions generated by LLM (solemn historical gravitas for context, rising dramatic tension, and skeptical questioning uptalk for rhetorical questions).<br/><strong>Mastering:</strong> Warmth EQ + De-Esser + EBU R128.",
            "theme": "indigo",
            "icon": "🎭"
        },
        {
