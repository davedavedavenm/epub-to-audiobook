...
|---|---|---|
| Fish S2 Pro (4.4B Dual-AR) / Cillian Murphy Irish Clone — **locked production recipe** (2026-09-22) | **Production winner for *The Armed Struggle*:** Dave's listening verdict on the bounded flat-reference retry: **"Fish S2 Pro retry voice is perfect."** This **reverses the 2026-09-18 bounded rejection** for exactly the boundary that rejection recorded — the failure was theatrical prompt prosody transfer, and the remedy it named (a flat, clean, non-theatrical studio prompt) is confirmed as the required operating mode. Recipe locked in `CILLIAN-RECIPE.md`: dual reference routing (`narration=cillian_irish.wav`, `quotes=crop_expressive_tail.wav`), temp 0.85, per-sentence bank + health gate + seed re-rolls 42/43/44, silence-trim with natural gaps, broadcast mastering. Rendered at zero cost on free Colab L4 lanes; sections gated by waveform + ASR completeness (word ≥0.93, coverage ≥0.90) — 3/10 gated PASS as of 2026-09-25, each 0.994 word ratio. Remaining open issue: **pronunciation of hard Irish terms read from anglo spelling** (ASR: "Padreik Paris", "deal era", "Toshak"). | Free Colab L4 lane (AI-Pro compute units) |
| Breeze TTS 2 (3.5B) / Cillian Murphy Irish Studio Clone (2026-09-19) | **Definitive winner for Irish & Multilingual content:** Dave's listening verdict: **"outstanding... almost perfect"**. Cloned from dry reference (`cillian_irish_dry.wav`), locked seed=42, guidance_scale=2.5. Flawlessly pronounced First Dáil, Cathal Brugha, Sinn Féin, Taoiseach, Tánaiste, Dún Laoghaire on tough Irish challenge. Selected 2026-09-19 for the full-book render of *The Armed Struggle* (11 chapters, ~150k words); **superseded 2026-09-22 by Fish S2 Pro** (row above) for that book. Broadcast mastered (-20 LUFS). | Modal Cloud GPU (Tesla T4 / Nvidia L4) |
...
## Official voice inventory for the screened CPU engines (2026-08-14, updated 2026-09-05)
